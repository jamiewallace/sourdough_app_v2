...
user1 = User.create!(username: "Makemybread", first_name: "Neha", last_name: "Shah", avatar: file1, first_line_address: "9 Back Hill", second_line_address: "", town_city: "London", postcode: "EC1R 5EN", country: "UK", description: "If you give me some sourdough starter I'll be eternally grateful.  I need lessons too!", have_need: 'need', email: "neha@neha.com", password: "password", password_confirmation: "password", role: "admin")
...
user3 = User.create!(username: "Breadman", first_name: "Alex", last_name: "Hamlin", avatar: file3, first_line_address: "13 Eyre Street Hill", second_line_address: "", town_city: "London", postcode: "EC1R 5ET", country: "UK", description: "Happy to share my yeast culture with all and sundry, especially the ladies!", have_need: 'have', email: "alex@alex.com", password: "password", password_confirmation: "password")

user4 = User.create!(username: "Sourandsweet", first_name: "Adam", last_name: "Buchan", avatar: file4, first_line_address: "4-5 Bonhill Street", second_line_address: "", town_city: "London", postcode: "EC2A 4BX", country: "UK", description: "I've been known to bake a mean loaf of bread in my time, and can share my skills...", have_need: 'have', email: "adam@adam.com", password: "password", password_confirmation: "password")
